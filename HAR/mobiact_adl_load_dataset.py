...
Original file is located at
    https://colab.research.google.com/drive/1shiPpJoDlVrfsO6rCyKhVG-TeMxBte05
...
[tensorflow git repo with more datasets](https://github.com/tensorflow/datasets) which also links to another colab [Keras MNIST Example](https://colab.research.google.com/github/tensorflow/datasets/blob/master/docs/keras_example.ipynb) with more options than one above.
